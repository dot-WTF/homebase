...
def create_model(model_name: OpenAIModels, temperature: float = 0) -> ChatOpenAI:
    return ChatOpenAI(
...
def create_house_agent(model_name: OpenAIModels, temperature: float = 0, verbose: bool = True) -> any:
